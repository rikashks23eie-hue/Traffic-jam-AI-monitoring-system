  ...
  try {
    ...
    if (registryCount === 0) {
      const dummyRegistry = [
        ...
        { plate: 'KA01CD5678', ownerName: 'Srikash KS', ownerPhone: '+91 9876543210', registeredAt: 'Bengaluru Central RTO (Koramangala)', vehicleType: 'Car', brand: 'Maruti', model: 'Swift', fuelType: 'Petrol', insuranceStatus: 'Active', registrationDate: new Date('2021-06-25') },
        { plate: 'KA05EF9012', ownerName: 'Ranganath Gowda', ownerPhone: '+91 9123456789', registeredAt: 'Bengaluru South RTO (Jayanagar)', vehicleType: 'Car', brand: 'Tata', model: 'Nexon EV', fuelType: 'Electric', insuranceStatus: 'Active', registrationDate: new Date('2023-11-02') },
        ...
        { plate: 'TN1234', ownerName: 'Enforcement Police Simulator', ownerPhone: '+91 9043475616', registeredAt: 'Bengaluru Police Headquarters', vehicleType: 'Emergency', brand: 'Force', model: 'Trax Ambulance', fuelType: 'Diesel', insuranceStatus: 'Active', registrationDate: new Date('2018-09-01') },
      ];
      await Registry.insertMany(dummyRegistry);
      console.log('🚗 RTO Vehicle Registry database seeded successfully');
    }
